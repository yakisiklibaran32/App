        ...
        if (auth.access_token && auth.refresh_token && auth.expires_in) {
          ...
          fetch('https://discord.com/api/users/@me', {
            ...
            .then(json => {
              ...
              auth.banner = json.banner != null ? `https://cdn.discordapp.com/banners/${json.id}/${json.banner}?size=1024` : 'https://raw.githubusercontent.com/Compliance-Resource-Pack/Branding/main/banner/c32.png'
